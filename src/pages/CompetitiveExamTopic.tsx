    ...
    <div className="min-h-[100dvh] w-full bg-background pb-24">
      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b border-border">
        <div className="flex items-center gap-3 px-4 py-3">
          <Button variant="ghost" size="icon" onClick={() => navigate(`/exam-prep/competitive/${examId}`)}>
        ...
        <div className="space-y-2">
          {topic.subtopics.map((subtopic, index) => (
            <Card 
              ...
              onClick={() => navigate(`/exam-prep/competitive/${examId}/${topicId}/content?subtopic=${encodeURIComponent(subtopic)}`)}
            >
...
export default CompetitiveExamTopic;